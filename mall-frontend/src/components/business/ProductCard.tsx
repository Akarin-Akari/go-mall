  ...
  return (
    <div className={`product-card ${className || ''}`} style={style}>
      ...
      <Card
        ...
        cover={
          <div style={{ position: 'relative', height: sizeConfig.imageHeight, overflow: 'hidden' }}>
            <Image
              alt={product.name}
              src={imageError ? '/images/product-placeholder.svg' : (product.images?.[0] || '/images/product-placeholder.svg')}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover',
            ...
            >
              <Space direction="vertical" size="small">
                <Button
                  ...
                  onClick={handleToggleFavorite}
                  style={{ 
                    backgroundColor: isFavorited ? '#ff4d4f' : 'rgba(0,0,0,0.6)',
          ...
          <Space direction="vertical" size={0}>
            ...
            {product.discount_price && parseFloat(product.discount_price) < parseFloat(product.price) && (
              <Tag color="red" size="small">
                省¥{formatPrice((parseFloat(product.price) - parseFloat(product.discount_price)).toString())}
              </Tag>
            )}
          </Space>
