...
const CartPage: React.FC = () => {
  ...
  const { items, total_amount, total_quantity, loading } = useAppSelector(selectCart);
  ...
  const selectedStats = React.useMemo(() => {
    ...
    const amount = selected.reduce((sum, item) => sum + (parseFloat(item.price) * item.quantity), 0);
    ...
    return (
      <MainLayout>
        <div style={{ padding: '0 24px', maxWidth: 1200, margin: '0 auto' }}>
          <Card style={{ marginTop: 24, textAlign: 'center', padding: '60px 0' }}>
            <Empty
              image={<ShoppingCartOutlined style={{ fontSize: 80, color: '#d9d9d9' }} />}
              description={
                <div>
                  <Title level={4} type="secondary">购物车是空的</Title>
              ...
              <div style={{ position: 'sticky', top: 80 }}>
                ...
                <Card style={{ marginBottom: 16 }}>
                  ...
                  <Space direction="vertical" style={{ width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Text>优惠券：</Text>
                      <Button type="link" size="small">选择优惠券</Button>
                    </div>
                  </Space>
                </Card>
                  ...
                  <Space direction="vertical" style={{ width: '100%' }} size="middle">
                    ...
                    <div style={{ marginTop: 16, padding: 12, backgroundColor: '#f9f9f9', borderRadius: 6 }}>
                      <Space wrap>
                        ...
                        <Tag icon={<TruckOutlined />} color="blue">极速发货</Tag>
