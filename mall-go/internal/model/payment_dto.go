...
// 错误定义
var (
	ErrInvalidPaymentMethod = NewError(400, "INVALID_PAYMENT_METHOD", "无效的支付方式")
	ErrInvalidAmount        = NewError(400, "INVALID_AMOUNT", "无效的金额")
	ErrPaymentNotFound      = NewError(404, "PAYMENT_NOT_FOUND", "支付记录不存在")
	ErrPaymentExpired       = NewError(400, "PAYMENT_EXPIRED", "支付已过期")
	ErrPaymentAlreadyPaid   = NewError(400, "PAYMENT_ALREADY_PAID", "支付已完成")
	ErrInsufficientAmount   = NewError(400, "INSUFFICIENT_AMOUNT", "金额不足")
	ErrRefundFailed         = NewError(500, "REFUND_FAILED", "退款失败")
)
